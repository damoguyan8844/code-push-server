...
config.development = {
  ...
  local: {
    ...
    storageDir: process.env.STORAGE_DIR || "/Users/zhanghongwei/Development/code-push-server/storage",
    // Binary files download host address which Code Push Server listen to. the files storage in storageDir.
    downloadUrl: process.env.LOCAL_DOWNLOAD_URL || "http://192.168.1.197:3000/download",
  ...
  common: {
    ...
    dataDir: process.env.DATA_DIR || "/Users/zhanghongwei/Development/code-push-server/data",
